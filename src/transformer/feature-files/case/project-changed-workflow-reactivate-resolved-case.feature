@NotAutomated
@JIRA-Key-MANUSCRIPT-30068
@Case
Feature: Case - Project - Changed Workflow - Reactivate resolved case
  ...
  Background:
    ...
    And The "5k Rewrite - Old" workflow has the following workflow rules:
      ...
      | Customer Feature | Reactivating a Resolved Case | Active | Ticker Assignee - Old | false             |
    ...
    And The following cases exist:
      ...
      | 17 | Test Case | FogBugz (5k Rewrite) | Ticker Assignee - Old | Resolved (Completed) |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is set to "No Change"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To       | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is set to "Case Opener"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To         | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is set to "Case Resolver"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To           | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is set to a specific user
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To          | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is forced to "Primary Contact"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To             | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is forced to "No Change"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To       | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is forced to "Case Opener"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To         | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is forced to "Case Resolver"
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To           | Force "Assign To" |
  ...
  Scenario: Changed project workflow: Reactivate resolved case: Project workflow rule: Current case category and default active status: "Assign To" is forced to a specific user
    Given The "5k Rewrite" workflow has the following workflow rules:
      | Category         | Action                       | Status | Assign To          | Force "Assign To" |
