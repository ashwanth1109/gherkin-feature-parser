@NotAutomated
@JIRA-Key-MANUSCRIPT-30161
@Case
Feature: Case - Project - Workflow - Create public case
  ...
  Scenario Outline: Create public case: Project workflow rule: Default case category for new emails ("Inquiry") and default active status: "Assign To" is set to "Primary Contact"
