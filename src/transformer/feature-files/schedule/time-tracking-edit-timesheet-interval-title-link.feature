@NotAutomated
@JIRA-Key-MANUSCRIPT-32203
@Schedule
Feature: Schedule - Time Tracking - Edit Timesheet - Interval - Title Link

  Scenario: User can open case page form time interval by clicking case title
    ...
    And The user clicks the "BugA" link for the "1" time interval row in the "Edit Timesheet" dialog
