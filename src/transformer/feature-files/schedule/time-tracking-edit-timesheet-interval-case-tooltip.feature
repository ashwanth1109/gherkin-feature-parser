@NotAutomated
@JIRA-Key-MANUSCRIPT-32202
@Schedule
Feature: Schedule - Time Tracking - Edit Timesheet - Interval - Case Tooltip

  Scenario: User can see case details by hovering over case id for the time interval
    ...
    And The user hovers over the "17" link for the "1" row in the "Edit Timesheet" dialog
