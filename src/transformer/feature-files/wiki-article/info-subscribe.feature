@NotAutomated
@JIRA-Key-MANUSCRIPT-31278
@WikiArticle
Feature: Wiki article - Info - Subscribe

  Scenario: Administrator user can subscribe to an existing wiki article using the "Info" button
    ...
    And The user clicks the "Subscribe" button in the "Wiki Article Info" page
    ...
    And The user clicks the "View" button in the "Wiki Article Info" page
