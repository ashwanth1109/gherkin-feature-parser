@NotAutomated
@JIRA-Key-MANUSCRIPT-29765
@Project
Feature: Project - Edit - Project group - Add

  Scenario: Administrator can edit an existing project: Add the project to an existing project group
    ...
    And The following project groups are listed in the "Project Groups" table in the "Edit Project" page in the following order:
      ...
      | true   | Key company projects | The group of the most important company projects. |
    ...
    And The following projects are listed in the "Projects" table in the "Projects" page in the following order:
      ...
      | true     | true       | FogBugz 5k Rewrite | Administrator   | 5k Rewrites, Key company projects, Software | Default Workflow |                            |
    ...
    And The following project groups are listed in the "Project Groups" table in the "Projects" page in the following order:
      ...
      | true     | true       | Key company projects | FogBugz 5k Rewrite | true            | The group of the most important company projects. |
