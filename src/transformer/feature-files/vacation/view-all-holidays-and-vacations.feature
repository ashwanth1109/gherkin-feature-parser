@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-30917
@Vacation
Feature: Vacation - View all - Holidays and Vacations

  Scenario: User can view all existing holidays and vacations: Both holidays and vacations are ordered by "Date" in ascending order
    ...
    And The user is logged in as Normal User
    ...
    Then The following holidays and vacations are listed in the "Holidays and Vacations" table in the "Upcoming Holidays and Vacations" section in the "My Working Schedule" page in the following order:
      ...
      | false    | false      | Test all-day 5     | 01/01/2098          | 01/14/2098           |
      | false    | false      | Test 3             | 01/01/2099 12:30 AM | 01/14/2099 1:00 AM   |
      | false    | false      | Test 1             | 01/01/2099 1:00 AM  | 01/14/2099 1:00 PM   |
      | true     | true       | Test all-day 6     | 01/02/2099          | 01/12/2099           |
      | false    | false      | Test all-day 7     | 01/03/2099          | 01/09/2099           |
