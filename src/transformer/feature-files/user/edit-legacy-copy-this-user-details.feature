@NotAutomated
@JIRA-Key-MANUSCRIPT-29828
@User
Feature: User - Edit - Legacy - Copy this user - Details

  Scenario: Administrator can view user options of a user being copied from legacy options
