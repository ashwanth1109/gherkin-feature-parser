@JIRA-Key-MANUSCRIPT-30064
@User
@ResetState
Feature: User - View "Manage Users" page - Filter tab - Inactive

  Scenario: View "Manage Users" page: "Inactive" tab: All inactive users are listed.
