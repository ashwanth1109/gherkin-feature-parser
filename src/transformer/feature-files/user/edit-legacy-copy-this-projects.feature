@NotAutomated
@JIRA-Key-MANUSCRIPT-30289
@User
Feature: User - Edit - Legacy - Copy this user - Projects

  Scenario: Administrator can view projects copied user has access to when copying from legacy options
