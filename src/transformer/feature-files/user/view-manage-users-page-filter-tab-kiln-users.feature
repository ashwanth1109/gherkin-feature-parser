@JIRA-Key-MANUSCRIPT-30063
@User
@ResetState
Feature: User - View "Manage Users" page - Filter tab - Kiln Users

  Scenario: View "Manage Users" page: "Kiln Users" tab: All active Kiln users are listed.
    ...
    When The user clicks the "Kiln Users" tab in the "Manage Users" page
