@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-31184
@WikiTemplate
Feature: Wiki template - Render Wiki article - Placeholder - url

  Scenario: User can view rendered Wiki article: "$url$" placeholder: URL of current article
    Given The user is logged in as Administrator
    And The following wiki templates exist:
      | Template                | wiki-page-content div HTML |
      | Rendering Wiki template | $url$                      |
