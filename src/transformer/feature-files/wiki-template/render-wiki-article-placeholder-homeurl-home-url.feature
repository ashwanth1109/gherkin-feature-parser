@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-31191
@WikiTemplate
Feature: Wiki template - Render Wiki article - Placeholder - homeurl, home_url

  Scenario Outline: User can view rendered Wiki article: "$homeurl$", "$home_url$" placeholders: URL of wiki's home article
