@NotAutomated
@JIRA-Key-MANUSCRIPT-31186
@WikiTemplate
Feature: Wiki template - Create - Placeholder - tags_vertical

  Scenario: User can view rendered Wiki article: "$tags_vertical$" placeholder: Vertical list of tags that have been applied to current article
    Given The user is logged in as Administrator
    And The following wiki templates exist:
      | Template                | wiki-page-content div HTML |
      | Rendering Wiki template | $tags_vertical$            |
