@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-31209
@WikiTemplate
Feature: Wiki template - Edit - CSS
  ...
  Background:
    ...
    When The user enters the wiki template details in the "Edit Template" page:
      | CSS                                      |
      | span.Terminal { font-family: Terminal; } |

  Scenario: Administrator can edit an existing Wiki template: "CSS": "Save" button
    ...
    And The following wiki template details are shown in the "Edit Template" page:
      | Template             | HTML                             | CSS                                      | Change |
      | Custom Wiki template | <div id="container">Custom</div> | span.Terminal { font-family: Terminal; } |        |
  ...
  Scenario: Administrator can edit an existing Wiki template: "CSS": "Save and Close" button
