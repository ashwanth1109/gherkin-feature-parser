@NotAutomated
@JIRA-Key-MANUSCRIPT-31200
@WikiTemplate
Feature: Wiki template - Render Wiki article - Placeholder - wiki_root_link, wikirootlink

  Scenario Outline: User can view rendered Wiki article: "$wiki_root_link$", "$wikirootlink$" placeholders: A link to the root page of a wiki
