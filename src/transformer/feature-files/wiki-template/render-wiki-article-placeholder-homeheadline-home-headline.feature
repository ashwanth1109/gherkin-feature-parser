@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-31192
@WikiTemplate
Feature: Wiki template - Render Wiki article - Placeholder - homeheadline, home_headline

  Scenario Outline: User can view rendered Wiki article: "$homeheadline$", "$home_headline$" placeholders: Headline of wiki's home article
    ...
    And The following wikis exist:
      ...
      | Rendering Wiki | Rendering Wiki Root Page Title! |
    ...
    And The following wiki article details are shown in the "View Wiki Article" page:
      ...
      | First Article | Rendering Wiki Root Page Title! |
    Examples:
      | Placeholder     |
      | $homeheadline$  |
      | $home_headline$ |
