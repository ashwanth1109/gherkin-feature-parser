@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-31183
@WikiTemplate
Feature: Wiki template - Render Wiki article - Placeholder - body

  Scenario: User can view rendered Wiki article: "$body$" placeholder: Content of current article
    Given The user is logged in as Administrator
    And The following wiki templates exist:
      | Template                | wiki-page-content div HTML |
      | Rendering Wiki template | $body$                     |
    ...
    And The following wiki article details are shown in the "View Wiki Article" page:
      ...
      | First Article | This is the first wiki article! |
