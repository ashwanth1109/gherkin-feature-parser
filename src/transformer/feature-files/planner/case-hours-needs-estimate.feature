@NotAutomated
@JIRA-Key-MANUSCRIPT-31038
@Planner
Feature: Planner - Case - Hours - Needs Estimate
  ...
  Scenario Outline: User can provide hours estimation for active cases
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Status   |
    When The user clicks the "Needs Estimate" link for the "<Active Case>" case in the "Hurricane" milestone in the "Planner" page
    And The user enters the following details in the "Estimate hours" field for the "<Active Case>" case in the "Hurricane" milestone in the "Planner" page:
      | 3 |
  ...
  Scenario Outline: User cannot provide hours estimation for resolved cases in planners
  ...
  Scenario Outline: User cannot provide hours estimation for closed cases in planners
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Status   |
