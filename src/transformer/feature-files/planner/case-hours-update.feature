@NotAutomated
@JIRA-Key-MANUSCRIPT-31040
@Planner
Feature: Planner - Case - Hours - Update
  ...
  Scenario Outline: User can update hours estimation for active cases
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Status   |
    When The user clicks the "Estimate hours" link for the "<Active Case>" case in the "Hurricane" milestone in the "Planner" page
  ...
  Scenario Outline: User cannot update hours estimation for resolved cases in planners
  ...
  Scenario Outline: User cannot update hours estimation for closed cases in planners
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Status   |
