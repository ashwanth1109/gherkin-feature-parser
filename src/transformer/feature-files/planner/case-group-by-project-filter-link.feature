@NotAutomated
@JIRA-Key-MANUSCRIPT-31065
@Planner
Feature: Planner - Case - Group By Project - Filter link

  Scenario: Grouping by "Project" has filter link
    ...
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Project  |
    And The user clicks the "Ninja" link in the "Hurricane" milestone in the "Planner" page
    Then The "Filters" page is shown
    And The following filter is shown:
      | First 200 cases in milestone Hurricane containing (project:"Ninja") |
