@NotAutomated
@JIRA-Key-MANUSCRIPT-31473
@Planner
Feature: Planner - Kanban - Case - Story Points - Needs Estimate
  ...
  Scenario Outline: User can provide story point estimation for active cases
    When The user clicks the "Needs Estimate" link for the "<Active Case>" case in the "Planned Cases" column
    And The user enters the following details in the "Estimate pts" field for the "<Active Case>" case in the "Planned Cases" column:
      | 3 |
  ...
  Scenario Outline: User cannot provide story point estimation for resolved cases in planners
    When The user clicks the "Resolved" link for the "<Resolved Case>" case in the "Planned Cases" column
    Then The "Estimate pts" field is not shown for the "<Resolved Case>" case in the "Planned Cases" column
    Examples:
      | Resolved Case |
      | BugR          |
      | InquiryR      |
