@NotAutomated
@JIRA-Key-MANUSCRIPT-31446
@Planner
Feature: Planner - Kanban - Group By Assigned To - Filter link

  Scenario: Grouping by "Assigned To" has a filter link in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By    |
      | Assigned To |
    And The user clicks the "Administrator" link in the "Planned Cases" column
    Then The "Filters" page is shown
    And The following filter is shown:
      | First 200 cases assigned to Administrator in milestone Hurricane containing kanban:=0 and (project:"Ninja") |
