@NotAutomated
@JIRA-Key-MANUSCRIPT-31061
@Planner
Feature: Planner - Case - Group By None - Filter link

  Scenario: Grouping by none has a filter link
    ...
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | None     |
    And The user clicks the "Cases" link in the "Hurricane" milestone in the "Planner" page
    Then The "Filters" page is shown
    And The following filter is shown:
      | First 200 open cases in milestone Hurricane containing (project:"Ninja") |
