@NotAutomated
@JIRA-Key-MANUSCRIPT-31456
@Planner
Feature: Planner - Kanban - Group By Project - Backlog Order

  Scenario: Grouping by "Project" allows changing backlog order in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By |
      | Project  |
    And The following cases are shown in the "Ninja" section in the "Planned Cases" column:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
    And The following cases are shown in the "Samurai" section in the "Planned Cases" column:
      | 19 | BugRA | 2 - Must Fix |
    And The user drags the "BugA" case to the top of the "Ninja" section in the "Planned Cases" column
