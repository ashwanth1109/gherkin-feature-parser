@NotAutomated
@JIRA-Key-MANUSCRIPT-31449
@Planner
Feature: Planner - Kanban - Group By None

  Scenario: Grouping by none lists all cases in a single column in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By |
      | None     |
    Then The following cases are shown in the "Cases" section in the "Planned Cases" column:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
