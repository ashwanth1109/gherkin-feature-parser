@NotAutomated
@JIRA-Key-MANUSCRIPT-31057
@Planner
Feature: Planner - Case - Group By Project

  Scenario: Grouping by "Project" groups cases by project
    ...
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Project  |
    Then The following cases are shown in the "Ninja" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
