@NotAutomated
@JIRA-Key-MANUSCRIPT-31044
@Planner
Feature: Planner - Case - Actions - Change Status - Drag and Drop
  ...
  Scenario Outline: User can resolve an active case by drag and drop in planners
    When The user drags the "<Case>" case to the "<New Status>" group in the "Hurricane" milestone in the "Planner" page
  ...
  Scenario Outline: User can close a resolved case by drag and drop in planners
    When The user drags the "<Case>" case to the "Closed" group in the "Hurricane" milestone in the "Planner" page
    Then The following cases are shown in the "Hurricane" milestone in the "Planner" page:
      | Title  | Status |
      | <Case> | Closed |
    And The user clicks the "<Case>" case in the "Hurricane" milestone in the "Planner" page
  ...
  Scenario Outline: User can reactivate a resolved by drag and drop in planners
