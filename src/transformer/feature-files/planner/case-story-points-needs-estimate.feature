@NotAutomated
@JIRA-Key-MANUSCRIPT-31037
@Planner
Feature: Planner - Case - Story Points - Needs Estimate
  ...
  Scenario Outline: User cannot provide story point estimation for closed cases in planners
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Status   |
