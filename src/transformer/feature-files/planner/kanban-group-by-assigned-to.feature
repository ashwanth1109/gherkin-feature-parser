@NotAutomated
@JIRA-Key-MANUSCRIPT-31450
@Planner
Feature: Planner - Kanban - Group By Assigned To

  Scenario: Grouping by "Assigned To" groups by assignee in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By    |
      | Assigned To |
    Then The following cases are shown in the "Administrator" section in the "Planned Cases" column:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
