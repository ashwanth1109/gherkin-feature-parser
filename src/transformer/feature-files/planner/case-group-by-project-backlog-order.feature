@NotAutomated
@JIRA-Key-MANUSCRIPT-31051
@Planner
Feature: Planner - Case - Group By Project - Backlog Order

  Scenario: Grouping by "Project" allows changing backlog order
    ...
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Project  |
    And The following cases are shown in the "Ninja" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
    And The following cases are shown in the "Samurai" section in the "Hurricane" milestone in the "Planner" page:
      | 19 | BugC | 2 - Must Fix |
    When The user drags the "BugA" case to the top of the "Ninja" section in the "Hurricane" milestone in the "Planner" page
