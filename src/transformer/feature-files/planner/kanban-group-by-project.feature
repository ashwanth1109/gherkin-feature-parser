@NotAutomated
@JIRA-Key-MANUSCRIPT-31452
@Planner
Feature: Planner - Kanban - Group By Project

  Scenario: Grouping by "Project" groups cases by project in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By |
      | Project  |
    Then The following cases are shown in the "Ninja" section in the "Planned Cases" column:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
