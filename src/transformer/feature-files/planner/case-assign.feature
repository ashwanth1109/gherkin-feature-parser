@NotAutomated
@JIRA-Key-MANUSCRIPT-31036
@Planner
Feature: Planner - Case - Assign
  ...
  Scenario: Change active bug assignment in planners
    When The user clicks the "Administrator" icon for the "BugA" case in the "Hurricane" milestone in the "Planner" page
  ...
  Scenario: Change resolved bug assignment in planners
    When The user clicks the "Administrator" icon for the "BugR" case in the "Hurricane" milestone in the "Planner" page
    And The user selects the "Lion King" option from the "Assign" dropdown
    Then The following cases are shown in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Assigned To |
      | 17 | BugR  | Lion King   |
  ...
  Scenario: User cannot change assignment of a closed bug in planners
    When The user clicks the "Administrator" icon for the "BugC" case in the "Hurricane" milestone in the "Planner" page
