@NotAutomated
@JIRA-Key-MANUSCRIPT-31455
@Planner
Feature: Planner - Kanban - Group By Priority - Backlog Order

  Scenario: Grouping by "Priority" allows changing backlog order in kanban
    ...
    When The user enters the following details for the "Planned Cases" column:
      | Group By |
      | Priority |
    And The following cases are shown in the "1 - Must Fix" section in the "Planned Cases" column:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 1 - Must Fix |
    And The following cases are shown in the "2 - Must Fix" section in the "Planned Cases" column:
      | 19 | BugRA | 2 - Must Fix |
    And The user drags the "BugA" case to the top of the "1 - Must Fix" section in the "Planned Cases" column
