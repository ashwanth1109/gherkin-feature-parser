@NotAutomated
@JIRA-Key-MANUSCRIPT-31054
@Planner
Feature: Planner - Case - Group By Assigned To

  Scenario: Grouping by "Assigned To" groups by assignee
    ...
    When The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By    |
      | Assigned To |
    Then The following cases are shown in the "Administrator" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
