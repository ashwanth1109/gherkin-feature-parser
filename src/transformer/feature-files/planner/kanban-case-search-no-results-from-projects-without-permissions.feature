@NotAutomated
@JIRA-Key-MANUSCRIPT-31463
@Planner
Feature: Planner - Kanban - Case - Search - No results from projects without permissions

  Scenario: Cases from projects that user has no access to are not found in kanban case search
    ...
    And The user clicks the "Open kanban view" button in the "Configure further" milestone in the "Planner" page
