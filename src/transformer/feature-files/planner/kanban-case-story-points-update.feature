@NotAutomated
@JIRA-Key-MANUSCRIPT-31475
@Planner
Feature: Planner - Kanban - Case - Story Points - Update
  ...
  Scenario Outline: User can update story point estimation for active cases
    And The user enters the following details for the "Planned Cases" column:
      | Group By |
      | Status   |
    When The user clicks the "2 pts" link for the "<Active Case>" case in the "Planned Cases" column
