@NotAutomated
@JIRA-Key-MANUSCRIPT-31050
@Planner
Feature: Planner - Case - Group By Priority - Backlog Order

  Scenario: Grouping by "Priority" allows changing backlog order
    ...
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | Priority |
    And The following cases are shown in the "1 - Must Fix" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 1 - Must Fix |
    And The following cases are shown in the "2 - Must Fix" section in the "Hurricane" milestone in the "Planner" page:
      | 19 | BugC | 2 - Must Fix |
    When The user drags the "BugA" case to the top of the "1 - Must Fix" section in the "Hurricane" milestone in the "Planner" page
