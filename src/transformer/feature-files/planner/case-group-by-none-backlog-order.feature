@NotAutomated
@JIRA-Key-MANUSCRIPT-31047
@Planner
Feature: Planner - Case - Group By None - Backlog Order

  Scenario: Grouping by none allows changing backlog order
    ...
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By |
      | None     |
    And The following cases are shown in the "Cases" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
    When The user drags the "BugA" case to the top of the "Cases" section in the "Hurricane" milestone in the "Planner" page
