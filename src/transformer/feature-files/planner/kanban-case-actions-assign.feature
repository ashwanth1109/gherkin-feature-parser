@NotAutomated
@JIRA-Key-MANUSCRIPT-31471
@Planner
Feature: Planner - Kanban - Case - Actions - Assign
  ...
  Scenario: Change active bug assignment through action dropdown in kanban
  ...
  Scenario: Change resolved bug assignment through action dropdown in kanban
