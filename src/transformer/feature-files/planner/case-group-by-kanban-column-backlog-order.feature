@NotAutomated
@JIRA-Key-MANUSCRIPT-31049
@Planner
Feature: Planner - Case - Group By Kanban Column - Backlog Order

  Scenario: Grouping by "Kanban Column" allows changing backlog order
    ...
    And The user enters the following details for the "Hurricane" milestone in the "Planner" page:
      | Group By      |
      | Kanban Column |
    And The following cases are shown in the "Doing" section in the "Hurricane" milestone in the "Planner" page:
      | ID | Title | Priority     |
      | 17 | BugR  | 1 - Must Fix |
      | 18 | BugA  | 3 - Must Fix |
    And The following cases are shown in the "Done" section in the "Hurricane" milestone in the "Planner" page:
      | 19 | BugC | 2 - Must Fix |
    When The user drags the "BugA" case to the top of the "Doing" section in the "Hurricane" milestone in the "Planner" page
