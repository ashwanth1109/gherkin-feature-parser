@NotAutomated
@JIRA-Key-MANUSCRIPT-31881
@Notification
Feature: Notification - Type - Notify

  Scenario: Notify notification is shown when user is in the "Notify More Users" list
    ...
    Then The following notifications are shown in the "Notifications" page in the following order:
      ...
      | Notify | 17: Capital | lk notified you and send an email | Notify | Just now | false |
