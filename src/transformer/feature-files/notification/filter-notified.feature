@NotAutomated
@JIRA-Key-MANUSCRIPT-31889
@Notification
Feature: Notification - Filter - Notified

  Scenario: Notifications can be filters by type - notified
    ...
    When The user clicks the "Notified" button in the "Notifications" page
