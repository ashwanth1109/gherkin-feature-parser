@NotAutomated
@JIRA-Key-MANUSCRIPT-31865
@Notification
Feature: Notification - Quick Menu - Case tooltip

  Scenario: User can see case tooltip from notifications sidebar menu
    ...
    When The user hovers over the "16: Intro Case for Administrator" notification in the sidebar menu
