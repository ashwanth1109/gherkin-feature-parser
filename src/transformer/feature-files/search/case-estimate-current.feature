@NotAutomated
@JIRA-Key-MANUSCRIPT-31535
@Search
Feature: Search - Case - Estimate Current

  Scenario: Administrator user can search cases using the current estimate time as axis for search
    ...
    When The user searches for the "EstimateCurrent:0.08h" search string by using the "Search cases & wikis" search box
