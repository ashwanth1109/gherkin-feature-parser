@NotAutomated
@JIRA-Key-MANUSCRIPT-30893
@Search
Feature: Search - Case - Action Bar - Reactivate
  ...
  Scenario: Administrator user can reactivate a resolved case from search results in Search page
    ...
    When The user clicks the "Reactivate" button in the "Search" page
  ...
  Scenario: Administrator user cannot reactivate a closed case from search results in Search page
    ...
    Then The "Reactivate" option is disabled in the "Search" page
