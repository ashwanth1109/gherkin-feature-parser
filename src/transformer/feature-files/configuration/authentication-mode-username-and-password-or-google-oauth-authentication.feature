@NotAutomated
@JIRA-Key-MANUSCRIPT-31667
@Configuration
Feature: Configuration - Authentication Mode - Username and Password or Google OAuth Authentication
  ...
  Scenario: Administrator can set authentication mode to user and password
    ...
    When The user selects the "Username and Password or Google OAuth Authentication" option from the "Authentication Mode" dropdown
    ...
    And The "Sign in with Google" button is shown in the "Login" page
