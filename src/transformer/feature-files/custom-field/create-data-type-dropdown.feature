@NotAutomated
@JIRA-Key-MANUSCRIPT-29662
@CustomField
Feature: Custom Field - Create - Data Type - Dropdown

  Scenario: Can define values for dropdown custom field
    ...
    And The following values are available for the "CFL1" custom field in the "New Case" page:
      | 1     |
      | 2 two |
      | 2f    |
