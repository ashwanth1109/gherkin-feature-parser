@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-29107
@Workflow
Feature: Workflow - Create
  ...
  Background:
    ...
    And The user clicks the "Create Workflow" link in the "Workflows" page

  Scenario: Administrator can create a new workflow: "Workflow name"
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
    And The user clicks the "OK" button in the "Create Workflow" page
  ...
  Scenario Outline: Administrator can create a new workflow: "Workflow name" and "Assign To" for a "Creating or Editing the status of an Active Case" status
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
    And The user enters the workflow rules details in the "Create Workflow" page:
      | Category         | Action                                           | Status | Assign To   | Force "Assign To" |
  ...
  Scenario Outline: Administrator can create a new workflow: "Workflow name" and "Assign To" for a "Reactivating a Resolved Case" status
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
  ...
  Scenario Outline: Administrator can create a new workflow: "Workflow name" and "Assign To" for a "Reopening a Closed Case" status
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
  ...
  Scenario Outline: Administrator can create a new workflow: "Workflow name" and "Assign To" for a "Resolving a Case" status
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
  ...
  Scenario Outline: Administrator can create a new workflow: "Workflow name" and "Force "Assign To"" for statuses
    Given The "Create Workflow" page is shown
    When The user enters the workflow details in the "Create Workflow" page:
      | Workflow Name |
      | 5k Rewrite    |
