@NotAutomated
@JIRA-Key-MANUSCRIPT-31854
@Subscription
Feature: Subscription - Delete - Deleting project removes subscription to the project

  Scenario: Administrator is auto unsubscribed to a project when the project is deleted
    ...
    And The following subscriptions exist:
      ...
      | true       | Subscribed to project "Test Inbox" |
