@NotAutomated
@JIRA-Key-MANUSCRIPT-30344
@Subscription
Feature: Subscription - Create - Any item I create - Discussion Topic

  Scenario: Administrator user is auto subscribed to a discussion topic they create when they have auto subscribed to subscription "Subscribed to ANY ITEM I CREATE"
    ...
    And The following options are shown in the "View Discussion Group" page:
