@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-29998
@Subscription
Feature: Subscription - Create - Any item I create - Duplicates

  Scenario: Administrator cannot auto subscribe to any item they create multiple times by clicking on the "Add New Subscription" link
    ...
    And The subscription "Subscribed to ANY ITEM I CREATE" is not added again to the subscription list
    And The following subscriptions are listed in the "Create an auto subscription" page in the following order:
        | Can Delete | Subscription                    |
        | true       | Subscribed to ANY ITEM I CREATE |

  Scenario: Administrator cannot auto subscribe to to any item they create multiple times by clicking on the "+" button left to the "Add New Subscription" link
    Given The user is logged in as Administrator
    And The following subscriptions exist:
        | Can Delete | Subscription                    |
        | true       | Subscribed to ANY ITEM I CREATE |
