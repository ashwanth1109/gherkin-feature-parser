@NotAutomated
@JIRA-Key-MANUSCRIPT-30358
@Subscription
Feature: Subscription - Create - Discussion Group - Discussion Topic

  Scenario: Administrator user is auto subscribed to any discussion topic they create in a discussion group when they have auto subscribed to that discussion group
