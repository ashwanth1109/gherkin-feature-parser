@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-30300
@Subscription
Feature: Subscription - Delete - Any item I create

  Scenario: Administrator can auto unsubscribe from any item they create
    ...
    When The user clicks the "Delete" button for the "Subscribed to ANY ITEM I CREATE" subscription in the "Create an auto subscription" page
