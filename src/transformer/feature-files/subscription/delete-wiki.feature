@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-30030
@Subscription
Feature: Subscription - Delete - Wiki

  Scenario: Administrator can auto unsubscribe from a wiki
    ...
    When The user clicks the "Delete" button for the "Subscribed to wiki "Wiki-W"" subscription in the "Create an auto subscription" page
