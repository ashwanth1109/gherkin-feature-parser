@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-30353
@Subscription
Feature: Subscription - Delete - All Discussion Groups

  Scenario: Administrator can auto unsubscribe from all discussion groups
    ...
    When The user clicks the "Delete" button for the "Subscribed to ALL DISCUSSION GROUPS" subscription in the "Create an auto subscription" page
