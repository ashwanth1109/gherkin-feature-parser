@PartiallyAutomated
@JIRA-Key-MANUSCRIPT-30351
@Subscription
Feature: Subscription - Create - All Discussion Groups

  Scenario: Administrator can auto subscribe to all discussion groups by clicking on the "Add New Subscription" link
  ...
  Scenario: Administrator can auto subscribe to all discussion groups by clicking on the "+" button left to the "Add New Subscription" link
    Given The user is logged in as Administrator
    And The user hovers over the "Avatar" icon at the bottom-left part in the sidebar
    And The user clicks the "Subscribe" menu item in the sidebar menu
    And The "Create an auto subscription" page is shown
